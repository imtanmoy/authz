...
//	groups, err := g.repository.List(ctx, organization.ID)
//	if err != nil {
//		return nil, err
//	}
...
//
//	newGroup, err := g.repository.Create(ctx, &group)
//	if err != nil {
//		return nil, err
//	}
...
//	ctx := context.Background()
//	group, err := g.repository.Find(ctx, ID)
//	if err != nil {
//		return nil, err
//	}
//	// get user list
...
//	}
//
//	err = g.repository.Update(ctx, tx, group)
//	if err != nil {
//		_ = tx.Rollback()
//		return err
//	}
...
//		return err
//	}
//	return g.repository.Delete(ctx, group)
//}
//
...
//	ctx := context.Background()
//	return g.repository.FindByName(ctx, organization, name)
//}
//
//func (g *groupService) FindByIdAndOrganizationId(Id int32, Oid int32) (*models.Group, error) {
//	ctx := context.Background()
//	group, err := g.repository.FindByIdAndOrganizationId(ctx, Id, Oid)
//	if err != nil {
//		return nil, err
//	}
//
